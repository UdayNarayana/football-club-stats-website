...
<body> 
	...
	<center><div style="background: rgba(0,0,0,0.3);width: 440px;height:80px;border-radius: 60px;">
		<h1 style="color: white;">Choose a Table To View From The Options Below</h1>
	</div></center>
